...
export default function Seo({ seo }) {
    return (
        <Head>
            ...
            <meta itemProp="description" content={seo.metaDescription} key="itemPropdescription" />
            ...
            <meta name="twitter:title" content={seo.metaHeading} key="twitter:title" />
            ...
            <meta property="og:site_name" key="og:site_name" content={seo.metaSiteName} />
            <meta property="og:title" key="og:title" content={seo.metaHeading} />
            <meta property="og:description" key="og:description" content={seo.metaDescription} />
            ...
            <meta property="og:image:width" key="og:image:width" content={seo.metaImgWidth} />
            <meta property="og:image:height" key="og:image:height" content={seo.metaImgHeight} />
