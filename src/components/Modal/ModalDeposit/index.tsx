...
export default function ModalDeposit({ openModal, setModalOpen, deposits, toggleModal }: any) {
  const depositActive = {
  ...
  const handleDepositSelected = (type: any, val: any) => {
