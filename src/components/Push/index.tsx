...
export default function Push({type, text, url, theme, close = false}: any) {
  ...
  return (
    show && <Link href={url} className={`${styles.push} ${styles[theme]}`}onClick={pushClose}>
    <div className={styles.push_container}>
        ...
        <div className={styles.push_content}>
            ...
            <div className={styles.push_text}>
                {text}
            </div>
        </div>
    </div>
